...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    SSOTestTableViewController *table = [SSOTestTableViewController new];
    table.tabBarItem.title = @"tableView";

    SSOTestCollectionViewController *collection = [SSOTestCollectionViewController new];
    collection.tabBarItem.title = @"Collection view";
    tabbar.viewControllers = @[ table, collection ];
